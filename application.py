#Steps to be followed before the identity and aunthentication can be configured. 
#https://pypi.org/project/flask-azure-oauth/#registering-an-application-in-azure
